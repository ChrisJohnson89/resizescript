...
echo "VARNISH: "
echo "  BEFORE: "
grep -E "malloc,\S*" /etc/systemd/system/varnish.service.d/override.conf
sed -i -E "s/malloc,\S*/malloc,$VARNISH/" /etc/systemd/system/varnish.service.d/override.conf
echo "  AFTER:"
grep -E "malloc,\S*" /etc/systemd/system/varnish.service.d/override.conf
